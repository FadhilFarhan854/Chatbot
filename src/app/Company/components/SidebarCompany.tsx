...
const SidebarCompany:React.FC<SidebarProps> = ({ toggleSidebar, onPageSelect }) =>{
    return(
        <>
            <section className=" w-full h-full dark:text-white text-black dark:bg-[#24252b] overflow-x-visible bg-white rounded-md shadow-[2px_2px_4px_-2px_rgba(0,0,0,0.1)] shadow-black border-4 dark:border-[#25262c] flex flex-col gap-5 px-3 overflow-y-auto">
                ...
                <div className="text-xs font-semibold ">
                    ...
                    <ul className=" text-sm mt-2 flex flex-col gap-1">
                        ...
                        <button onClick={()=>onPageSelect("List Wawancara")} className="p-1 py-2 flex items-center gap-2 rounded-sm dark:hover:bg-[#2a2b32] hover:bg-[#70d195] hover:shadow-sm hover:text-white group dark:hover:text-green-200 hover:shadow-green-200 duration-100">
                            <img src="/icons/list-text.png" className="dark:invert group-hover:invert h-5" alt=""/>
                            <p className="">List Wawancara</p>
                        </button>
                        <button onClick={()=>onPageSelect("Tambah Wawancara")} className="p-1 py-2 flex items-center gap-2 rounded-sm dark:hover:bg-[#2a2b32] hover:bg-[#70d195] hover:shadow-sm hover:text-white group dark:hover:text-green-200 hover:shadow-green-200 duration-100">
                            <img src="/icons/approval.png" className="dark:invert group-hover:invert h-5" alt=""/>
                            <p className="">Tambah Wawancara</p>
                        </button>
