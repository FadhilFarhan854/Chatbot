...
export const DetailpopupUser:React.FC<DetailInterviewUser> = ({detailprops, id, idCompany, companyName, alamat, bidang, startDate, deadline, listPertanyaan}) => {
