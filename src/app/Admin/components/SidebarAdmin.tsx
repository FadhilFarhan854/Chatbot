                ...
                <div className="text-xs font-semibold ">
                    ...
                    <ul className=" text-sm mt-2 flex flex-col gap-1">
                        ...
                        <button onClick={()=>onPageSelect("CApproval")} className="p-1 py-2 flex items-center gap-2 rounded-sm dark:hover:bg-[#2a2b32] hover:bg-[#70d195] hover:shadow-sm hover:text-white group dark:hover:text-green-200 hover:shadow-green-200 duration-100">
                            ...
                            <p className="">Aproval perusahaan</p>
                        </button>
                        <button onClick={()=>onPageSelect("InterviewApproval")} className="p-1 py-2 flex items-center gap-2 rounded-sm dark:hover:bg-[#2a2b32] hover:bg-[#70d195] hover:shadow-sm hover:text-white group dark:hover:text-green-200 hover:shadow-green-200 duration-100">
                            <img src="/icons/info.png" className="dark:invert group-hover:invert h-5" alt=""/>
                            <p className="">Aproval wawancara</p>
                        </button>
