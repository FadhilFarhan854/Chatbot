...
const BankSoal = () => {
    ...
    const bank = [
        ...
        { id: "37473722",pertanyaan:"Bahasa apa yang paling kamu kuasai dalam FE development ?", jenis:"Teknikal" ,bidang:"frontend" },
        ...
        { id: "37473726",pertanyaan:"bisakah kamu meggunakan laravel sebagai bahasa untuk backend  ?", jenis:"Teknikal" ,bidang:"Backend" },
            ...
            <p className="text-base md:text-lg">List of requested company</p>
                <ul className=" text-sm md:text-base w-full overflow-y-scroll scrollbar-hide flex flex-col gap-2">
                    <li className="w-full text-[#62d28d]  font-semibold border-b-2 text-base md:text-lg border-black dark:border-white flex">
                        ...
                        <p className="w-[45%] text-center flex justify-center items-center ">Pertanyaan</p>
                        <p className="w-[10%] text-center flex justify-center items-center ">Jenis</p>
                    ...
                    </li>
                    {
                        ...
                        <li key={index} className="w-full border-b-2 border-black dark:border-white flex">
                            ...
                            <p className="w-[45%] text-center flex justify-center items-center ">{soal.pertanyaan}</p>
                            <p className="w-[10%] text-center flex justify-center items-center ">{soal.jenis}</p>
                            <p className="w-[20%] text-center flex justify-center items-center ">{soal.bidang}</p>
